                            ...
                            <div class="sorter-wrapper d-flex align-items-center">
                                ...
                                >
                                    ...
                                    <ul class="select-input__list">
                                        ...
                                        <li class="select-input__item" data-sort="&sort_by=price_desc">Giá, Cao đến
                                            Thấp
                                        </li>
                                        <li class="select-input__item" data-sort="&sort_by=price_asc">Giá, Thấp đến
                                            Cao
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                ...
                                                <a href="{{URL::to('/shop-single/'.$pd->ProductSlug)}}">
                                                    <img
                                                        src="{{asset('storage/kidoldash/images/product/'.$image)}}"
                                                        alt="">
                                                </a>
                                                ...
                                                <div class="action-links">
                                                    <ul>
                                                        ...
                                                        <li><a class="add-to-compare" data-idcat="{{$pd->idCategory}}"
                                                               id="{{$pd->idProduct}}" data-tooltip="tooltip"
                                            ...
                                            <div class="product-content text-center">
                                                ...
                                                <div class="price-box">
                                                    @if($SalePrice < $pd->Price)
                                                        <span
                                                            class="old-price">{{number_format($pd->Price,0,',','.')}}đ</span>
                                ...
                                <div class="single-product product-list">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <ul class="action-links">
                                            ...
                                            <li><a class="add-to-compare" data-idcat="{{$pd->idCategory}}"
                                                   id="{{$pd->idProduct}}" data-tooltip="tooltip" data-placement="left"
                                ...
                                @foreach($list_category as $key => $category)
                                    <li class="d-flex align-items-center">
                                        ...
                                        class="filter-product" type="checkbox" id="cat-{{$category->idCategory}}"
                                                data-filter="category" value="{{$category->idCategory}}"
                                                name="category-filter" style="width:15px;height:15px;">
