...
<head>
    ...
    <title>Clothes Store Admin</title>
    ...
    <link rel="stylesheet"
          href="{{asset('public/kidoldash/vendor/line-awesome/dist/line-awesome/css/line-awesome.min.css')}}">
    ...
    <div class="iq-sidebar  sidebar-default ">
        <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
            <a href="{{URL::to('/dashboard')}}" class="header-logo">
                <img src="{{asset('public/kidoldash/images/logo.png')}}" class="img-fluid rounded-normal light-logo"
                     alt="logo">
                <h5 class="logo-title light-logo ml-2">Clothes Store</h5>
            </a>
        ...
        <div class="data-scrollbar" data-scroll="1">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li class=" ">
                        <a href="#pageComment" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <svg class="svg-icon" id="p-dash8" width="20" height="20" xmlns="http://www.w3.org/2000/svg"
                                 viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                 stroke-linecap="round" stroke-linejoin="round">
                                <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                        ...
                        <ul id="pageComment" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="{{ Request::is('manage-comment') ? 'active' : '' }}">
                                <a href="{{URL::to('/manage-comment')}}">
                                    <i class="las la-minus"></i><span>Danh sách đánh giá</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="card border-none">
                    <div class="card-body p-0">
                        <div class="sidebarbottom-content">
                            <div class="image"><img src="{{asset('public/kidoldash/images/layouts/side-bkg.png')}}"
        ...
        <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{URL::to('/dashboard')}}" class="header-logo">
                        <img src="{{asset('public/kidoldash/images/logo.png')}}" class="img-fluid rounded-normal"
                             alt="logo">
                        <h5 class="logo-title ml-3">Clothes Store</h5>
                        ...
                        <ul class="navbar-nav ml-auto navbar-list align-items-center">
                            <li class="nav-item nav-icon dropdown">
                                <a href="#" class="search-toggle dropdown-toggle btn border add-btn"
                                   ...
                                   aria-expanded="false">
                                    <img src="{{asset('public/kidoldash/images/small/Vietnam-Flag.png')}}"
                                         alt="img-flag"
                                    ...
                                    <div class="card shadow-none m-0">
                                        <div class="card-body p-3">
                                            <a class="iq-sub-card" href="#"><img
                                                    src="{{asset('public/kidoldash/images/small/flag-02.png')}}"
                                                    alt="img-flag"
                                                    class="img-fluid mr-2">French</a>
                                            <a class="iq-sub-card" href="#"><img
                                                    src="{{asset('public/kidoldash/images/small/flag-03.png')}}"
                                                    alt="img-flag"
                                                    class="img-fluid mr-2">Spanish</a>
                                            <a class="iq-sub-card" href="#"><img
                                                    src="{{asset('public/kidoldash/images/small/flag-04.png')}}"
                                                    alt="img-flag"
                                                    class="img-fluid mr-2">Italian</a>
                                            <a class="iq-sub-card" href="#"><img
                                                    src="{{asset('public/kidoldash/images/small/flag-05.png')}}"
                                                    alt="img-flag"
                                                    class="img-fluid mr-2">German</a>
                                            <a class="iq-sub-card" href="#"><img
                                                    src="{{asset('public/kidoldash/images/small/flag-06.png')}}"
                                                    alt="img-flag"
                                            ...
                                            <div class="px-3 pt-0 pb-0 sub-card">
                                                    ...
                                                    <div class="media align-items-center cust-card py-3 border-bottom">
                                                        <div class="">
                                                            <img class="avatar-50 rounded-small"
                                                                 src="{{asset('public/kidoldash/images/user/01.jpg')}}"
                                                                 alt="01">
                                                        </div>
                                                ...
                                                <a href="#" class="iq-sub-card">
                                                    <div class="media align-items-center cust-card py-3 border-bottom">
                                                        <div class="">
                                                            <img class="avatar-50 rounded-small"
                                                                 src="{{asset('public/kidoldash/images/user/02.jpg')}}"
                                                                 alt="02">
                                                        </div>
                                                        <div class="media-body ml-3">
                                                            <div
                                                ...
                                                <a href="#" class="iq-sub-card">
                                                    <div class="media align-items-center cust-card py-3">
                                                        <div class="">
                                                            <img class="avatar-50 rounded-small"
                                                                 src="{{asset('public/kidoldash/images/user/03.jpg')}}"
                                                                 alt="03">
                                                        </div>
                                                        <div class="media-body ml-3">
                                                            <div
                                            ...
                                            <div class="px-3 pt-0 pb-0 sub-card">
                                                <a href="#" class="iq-sub-card">
                                                    <div class="media align-items-center cust-card py-3 border-bottom">
                                                        <div class="">
                                                            <img class="avatar-50 rounded-small"
                                                                 src="{{asset('public/kidoldash/images/logo.png')}}"
                                                                 alt="01">
                                                        </div>
                                                        <div class="media-body ml-3">
                                                            <div
                                                            ...
                                                            <small class="mb-0">Đã đến thời gian sao lưu dữ liệu, nhấn
                                                                để xem chi tiết!</small>
                                                        </div>
                                                    </div>
                                                </a>
                                                <a href="#" class="iq-sub-card">
                                                    <div class="media align-items-center cust-card py-3 border-bottom">
                                                        ...
                                                        <div class="media-body ml-3">
                                                            ...
                                                            <small class="mb-0">Đã đến thời gian bảo trì hệ thống, nhấn
                                                                để xem chi tiết!</small>
                                                        </div>
                                                    </div>
                                                </a>
                            ...
                            <li class="nav-item nav-icon dropdown caption-content">
                                <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    @if($avatar != '')
                                        <img src="{{asset('storage/kidoldash/images/user/'.$avatar)}}"
                                             class="img-fluid rounded" alt="user">
                                    @else
                                        <img src="{{asset('public/kidoldash/images/user/12.jpg')}}"
                                             class="img-fluid rounded" alt="user">
                                    @endif
                                </a>
                                <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <div class="card shadow-none m-0">
                                        <div class="card-body p-0 text-center">
                                            <div class="media-body profile-detail text-center">
                                                <img src="{{asset('public/kidoldash/images/page-img/profile-bg.jpg')}}"
                                                     alt="profile-bg"
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center mt-3">
                                                    ...
                                                    <a href="{{URL::to('/admin-logout')}}" class="btn border">Đăng
                                                        Xuất</a>
                                                </div>
                                            </div>
                                        </div>
...
<link rel="stylesheet" type="text/css"
      href="{{asset('public/kidoldash/datetimepicker-master/jquery.datetimepicker.css')}}">
