...
|
*/
Route::get('/success-order', [\App\Http\Controllers\CartController::class, 'success']);
...
//Comment
Route::get('/manage-comment', 'CommentController@manage_comment');
Route::get('/delete-comment/{idView}', 'CommentController@delete_comment')
    ->name('admin.comment.delete');
use App\Http\Controllers\CommentController;

Route::get('/api/product/{productName}/comments', [CommentController::class, 'get_comments_by_product_name'])
    ->where('productName', '.*');
Route::post('/add-comment', [CommentController::class, 'add_comment'])->name('comment.add');


Route::put('/api/comments/{idView}', [CommentController::class, 'update_comment']);
Route::delete('/api/comments/{id}', [CommentController::class, 'delete_commentCus']);
Route::post('/admin/update-status/{idBill}', [\App\Http\Controllers\BillController::class, 'update_status']);
